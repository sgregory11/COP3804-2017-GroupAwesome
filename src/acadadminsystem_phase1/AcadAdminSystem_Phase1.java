...
public class AcadAdminSystem_Phase1 {
    ...
    public static void main(String[] args) {
        ...
        // create a acadadminsystem_phase1.School object with no students, instructors, or courses
        ...
        // create three acadadminsystem_phase1.Instructor objects
        ...
        // create six acadadminsystem_phase1.Course objects
        ...
        // create six acadadminsystem_phase1.CourseGrade objects
        ...
        // change the courseTaken field inside these 2 acadadminsystem_phase1.CourseGrade
        courseGrade_5.setCourseTaken(course_5);
        courseGrade_6.setCourseTaken(course_6);

        // changes to the acadadminsystem_phase1.Course objects should not affect the data inside the acadadminsystem_phase1.CourseGrade objects
        ...
        // create three ArrayLists of acadadminsystem_phase1.CourseGrade objects
        ...
        // create a acadadminsystem_phase1.Student object and display his information
        ...
        // create a acadadminsystem_phase1.DualEnrolledStudent object and display his information
        DualEnrolledStudent dualEnrlStudent = new DualEnrolledStudent("Mary", "Morales",
                2, "07/22/20014", "Undecided", dualEnrlStudentGrades, "Coral Park High acadadminsystem_phase1.School", 11);
        System.out.println("#####################################################");
        System.out.println("*        DUAL ENROLLED STUDENT INFORMATION          *");
        System.out.println("#####################################################");
        System.out.println(dualEnrlStudent + "\n");

        // create a acadadminsystem_phase1.TransientStudent object and display his information
